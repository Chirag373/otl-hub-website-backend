...
class BuyerProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'preferred_location', 'budget_range', 'subscription_plan', 'created_at')
    list_filter = ('subscription_plan', 'created_at')
    search_fields = ('user__email', 'user__first_name', 'user__last_name', 'preferred_location')
    ...
    fieldsets = (
        ...
        ('Preferences', {
            'fields': ('preferred_location', 'budget_range')
        }),
        ('Subscription', {
...
class RealtorProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'license_number', 'company_brokerage', 'years_of_experience', 'subscription_active', 'created_at')
    list_filter = ('years_of_experience', 'subscription_active', 'created_at')
    search_fields = ('user__email', 'user__first_name', 'user__last_name', 'license_number', 'company_brokerage')
    readonly_fields = ('created_at', 'updated_at')
...
class SellerProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'property_type', 'property_location', 'estimated_value', 'has_active_listing', 'created_at')
    list_filter = ('property_type', 'has_active_listing', 'created_at')
    search_fields = ('user__email', 'user__first_name', 'user__last_name', 'property_location')
    readonly_fields = ('created_at', 'updated_at')
    ...
    fieldsets = (
        ...
        ('Listing Status', {
            'fields': ('has_active_listing', 'listing_created_at')
        }),
        ('Timestamps', {
            'fields': ('created_at', 'updated_at')
        }),
...
class PartnerProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'company_name', 'partnership_type', 'subscription_active', 'created_at')
