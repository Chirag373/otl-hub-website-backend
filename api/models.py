...
class BuyerProfile(BaseModel):
    ...
    property_type = models.ManyToManyField(related_name='buyer_profile', choices=PropertyType.choices) 
...
class SellerProfile(BaseModel):
    ...
    property_type = models.ManyToManyField(related_name='seller_profile', choices=PropertyType.choices)
